...
fun NoCitiesMainScreenItem(
    ...
    Column(
        ...
        Text(
            text = stringResource(id = R.string.no_weather_data_available),
            style = headerStyle,
            modifier = Modifier
                .headerModifier()
                .fillMaxWidth()
        ...
        CardButton(
            buttonText = stringResource(id = R.string.please_allow_us_to_get_location_access),
        ...
        Text(
            text = stringResource(id = R.string.click_here_to_change_it_in_settings),
            fontSize = 22.sp,
            modifier = Modifier
                .fillMaxWidth()
                .padding(top = 12.dp)
        ...
        CardButton(
            buttonText = stringResource(id = R.string.or_find_city_manually),
